    ...
    <?php else : ?>
        <form id="form" class="" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="">
                ...
                <input type="text" class="" name="email" value="<?php if (!empty($_POST['email'])) {
                                                                                    echo h($_POST['email']);
                                                                                } ?>"><br />
            ...
            <div class="">
                <label class="">郵便番号</label><br class="">
